                ...
                ?>
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <?php  $count = 0; foreach ($txtboxes as $txtbox) { ?>

                                <?php if ($count == 0) { ?>
                                    <h2><?php echo  $txtbox['title'];?></h2>
                                    <p class="mb-g"><?php echo  $txtbox['text'];?></p>
                                <?php } else { ?>
                                    
                                    <h3><?php echo  $txtbox['title'];?></h3>
                                    <p ><?php echo  $txtbox['text'];?></p>
